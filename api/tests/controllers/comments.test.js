...
//     expect(response.body.comment.content).toBe("This is funny!");
//   });
...
//     expect(response.statusCode).toBe(200);
//     expect(response.body[0].content).toBe("Nice cat!");
//   });
...
//       .set("Authorization", `Bearer ${authToken}`)
//       .send({ content: "Fixed comment" });

//     expect(response.statusCode).toBe(200);
//     expect(response.body.comment.content).toBe("Fixed comment");
//   });
